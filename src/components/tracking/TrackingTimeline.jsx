				...
				<div className="relative flex flex-col md:flex-row items-center gap-5 p-6 md:p-8">
					...
					<div className="relative flex-shrink-0">
						...
						<div
							...
							style={{
								...
								boxShadow:
									'0 10px 25px -5px rgba(245, 158, 11, 0.3), 0 0 0 4px rgba(245, 158, 11, 0.08)',
							}}
						>
							<img
								src={NovedadIcon}
								...
								style={{
									filter:
										'brightness(0) saturate(100%) invert(62%) sepia(74%) saturate(1200%) hue-rotate(10deg) brightness(95%) contrast(92%)',
								}}
							/>
						</div>
					</div>
					...
					<div className="flex-1 text-center md:text-left">
						...
						<p
							...
							style={{ color: '#92400E' }}
						>
							Tu pedido presenta una novedad en el proceso de entrega. Por
							favor, comunícate con servicio al cliente o consulta directamente
							con la transportadora para más información.
						</p>
					</div>
				</div>
			</div>
